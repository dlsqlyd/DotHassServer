...
namespace Microsoft.Owin.Security
{
    ...
    {
        public const string IssuedUtcKey = ".issued";
        public const string ExpiresUtcKey = ".expires";
        public const string IsPersistentKey = ".persistent";
        public const string RedirectUriKey = ".redirect";
        public const string RefreshKey = ".refresh";
        public const string UtcDateTimeFormat = "r";
