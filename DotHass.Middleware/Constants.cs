namespace DotHass.Middleware
{
    public static class Constants
    {
        ...
        public static string HostServiceKey { get; } = "server.HostServiceKey";

        //中间件字典参数传递的serviceprovider。。
        public static string RequestServiceKey { get; } = "server.RequestService";

        //将appfun从server传递到底层channelhandler使用的attributekey
        public static string AppAttributeKey { get; } = "server.AppAttributeKey";

        public static class Headers
        {
            //socket
            public static string ClientId { get; } = "Client-Id";

            public static string MsgId { get; } = "Msg-Id";
            public static string ContractId { get; } = "Contract-Id";
            public static string SessionId { get; } = "Session-Id";
            public static string SignKey { get; } = "Sign-Key";
            ...
            public static string MediaType { get; } = "Media-Type";
            public static string Accept { get; } = "Accept";
            public static string Host { get; } = "Host";
            public static string ETag { get; } = "ETag";
            public static string Location { get; } = "Location";
            public static string SetCookie { get; } = "Set-Cookie";
